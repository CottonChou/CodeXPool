...
private struct AccountCardGridItem: View {
    ...
    var body: some View {
        ...
        .codeXPoolCardEntrance(index: index, isPresented: areCardsPresented)
...
private extension View {
    func codeXPoolCardEntrance(index: Int, isPresented: Bool) -> some View {
        ...
        VStack(alignment: .leading, spacing: 12) {
            ...
            if let errorMessage, cards.isEmpty {
                PendingWorkspaceAuthorizationFailureCard(message: errorMessage)
                    .codeXPoolCardEntrance(index: 0, isPresented: areCardsPresented)
                    .modifier(AccountCardFrameModifier())
                    .padding(.horizontal, LayoutRules.pagePadding)
            } else {
                LazyVGrid(
