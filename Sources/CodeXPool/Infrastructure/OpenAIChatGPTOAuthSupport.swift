...
enum OpenAIChatGPTOAuthSupport {
    ...
    static func errorPageHTML(message: String) -> Data {
        ...
        return Data("<html><head><meta charset=\"utf-8\"><title>CodeXPool</title></head><body style=\"font-family:-apple-system,BlinkMacSystemFont,sans-serif;padding:32px;\"><h2>Sign-in failed</h2><p>\(escapedMessage)</p></body></html>".utf8)
    }
