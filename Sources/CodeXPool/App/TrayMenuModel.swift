...
extension Notification.Name {
    static let codeXPoolAccountsSnapshotPushDidArrive = Notification.Name("codeXPool.accounts-snapshot.push")
    static let codeXPoolCurrentAccountSelectionPushDidArrive = Notification.Name("codeXPool.current-account-selection.push")
}
