...
final class RepositoryLocatorTests: XCTestCase {
    func testProxydManifestURLPrefersCurrentSourceLayout() throws {
        ...
        let currentManifest = root
            .appendingPathComponent("Sources/CodeXPool/Resources/proxyd-src/proxyd", isDirectory: true)
    ...
    func testFindRepoRootDiscoversCurrentSourceLayoutFromNestedFile() throws {
        ...
        let nestedFile = root
            .appendingPathComponent("Sources/CodeXPool/App/AppContainer.swift", isDirectory: false)
    ...
    private func makeTemporaryRoot() throws -> URL {
        let root = FileManager.default.temporaryDirectory
            .appendingPathComponent("codexpool-repository-locator-\(UUID().uuidString)", isDirectory: true)
